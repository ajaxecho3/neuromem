...
description: >
  Writes memories and associations during a conversation. Use when user states a
  preference ("I prefer", "I always", "I use"), shares a personal fact, makes a
  decision ("we're going with", "decided to"), completes a task ("done", "shipped",
  "merged"), describes a reusable workflow or procedure, or when two topics are
  clearly linked. Do NOT remember trivial acknowledgements ("ok", "thanks", "got it").
---
